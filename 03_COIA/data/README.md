...
3. `glasso_results_nomet.csv`: results from gLASSO on cleaned molecular descriptors database (cf. folder `01_molecular_descriptors/data/README.md` section;
4. `multispec_bsplines_median_agreg2_IGT.csv`: Aggregated substances (from their replicates) on $B$-spline coefficients computed on FDA curves from behavioural data (IGT metric).
