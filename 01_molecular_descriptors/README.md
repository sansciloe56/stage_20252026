...
2. clustering: creation variable to predict, y (categorical variable where each class is a substance class);
3. (feature_selection: select relevant molecular descriptors (data preprocessing and standardise the dataframe);)
4. (more to add later)
